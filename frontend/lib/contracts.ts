...
export const CONTRACTS = {
  CREDIT_IDENTITY: process.env.NEXT_PUBLIC_CREDIT_IDENTITY_ADDRESS || "0x02cB407dF115c7Bf287dEd05aab870485fC800aB",
  LOAN_MANAGER:    process.env.NEXT_PUBLIC_LOAN_MANAGER_ADDRESS    || "0xA29373f508CABcB647aC677C329f24a939b29776",
  SENIOR_TRANCHE:  process.env.NEXT_PUBLIC_SENIOR_TRANCHE_ADDRESS  || "0xe468781867732309f62aCD0Fa6Fb00549Bf96299",
  JUNIOR_TRANCHE:  process.env.NEXT_PUBLIC_JUNIOR_TRANCHE_ADDRESS  || "0x280979E7890bB8DDCaD92eF68c87F98452E5C856",
  USDC:            process.env.NEXT_PUBLIC_USDC_ADDRESS            || "0x036CbD53842c5426634e7929541eC2318f3dCF7e",
  CRE_CONSUMER:    process.env.NEXT_PUBLIC_CRE_CONSUMER_ADDRESS    || "0xa49Ae8a172017B6394310522c673A38d3D64b0A7",
  CCIP_SYNC:       process.env.NEXT_PUBLIC_CCIP_SYNC_ADDRESS       || "0x92e92bc8118aAE7704d1D0b05ec3d20b95F46ADe",
  WORLD_ID_GATE:   process.env.NEXT_PUBLIC_WORLD_ID_GATE_ADDRESS   || "0xe0af52d2056fd0D55f5F26275e6F3464582a37E9",
};
